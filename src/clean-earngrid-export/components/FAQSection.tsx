...
export function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes. IdleNet uses the same system-level safety protocols as antivirus software. Your personal files remain completely private and untouched. The software only uses spare processing power."
    },
    {
      question: "Will it slow down my computer?",
      answer: "No. IdleNet automatically pauses the moment you use your computer. It only runs during true idle time when you're not actively using your device."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolutely. IdleNet uninstalls completely like any other software. No residual files or changes remain on your system."
    }
  ];
