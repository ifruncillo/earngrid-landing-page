export function WhyItWorksSection() {
  return (
    <section className="w-full py-20 bg-gradient-to-b from-navy to-navy/95">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-semibold text-cream mb-4 font-heading">
            What's the catch? There isn't one.
          </h2>
          <p className="text-lg text-muted max-w-3xl mx-auto font-body">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="border border-red-500/20 bg-red-500/5 rounded-2xl p-8">
              <h3 className="text-2xl font-semibold text-cream mb-4 font-heading">
          ...
          {/* Right: The Solution */}
          <div className="space-y-8">
            <div className="border border-primary/20 bg-primary/5 rounded-2xl p-8">
              <h3 className="text-2xl font-semibold text-cream mb-4 font-heading">
                The simple solution
              </h3>
              <div className="space-y-4">
        ...
        <div className="text-center mt-16">
          <div className="bg-primary/10 border border-primary/20 rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-xl font-semibold text-cream mb-3 font-heading">
              It's that simple
            </h3>
